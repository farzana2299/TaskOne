                        ...
                        <div key={index}>
                            <div className="row">
                                <div className="col-lg-1">
                                    ...
                                    <input type="text" class="form-control" placeholder='1011' id="orderid" aria-describedby="orderid1"
                                        value={input.orderId} onChange={event => handleFormChange(index, event)}
                                    />
                                </div>
                                <div className="col-lg-1">
                                    <label for="itemno" class="form-label "><b>ITEM NO</b></label> <br />
                                    <input type="text" class="form-control"placeholder='1111' id="itemno" aria-describedby="itemno1"
                                        value={input.itemNo} onChange={event => handleFormChange(index, event)}
                                    />
                                </div>
                                <div className="col-lg-1">
                                    <label for="matid" class="form-label "><b>MATERIAL ID</b></label>
                                    <input type="text" class="form-control"placeholder=' 2222' id="matid" aria-describedby="matid1"
                                ...
                                <div className="col-lg-3">
                                    ...
                                    <input type="text" class="form-control"placeholder='Description about your Material' id="matdesc" aria-describedby="matdesc1"
                                ...
                                <div className="col-lg-1">
                                    ...
                                    <input type="number" class="form-control"placeholder=' 10' id="currqty" aria-describedby="currqty1"
                                ...
                                <div className="col-lg-1">
                                    ...
                                    <input type="number" class="form-control"placeholder=' 8' id="preqty" aria-describedby="preqty1"
                                ...
                                <div className="col-lg-1">
                                    ...
                                    <input type="number" class="form-control"placeholder=' 2' id="qtydiff" aria-describedby="qtydiff1"
                                ...
                                <div className="col-lg-2">
                                    ...
                                    <input type="text" class="form-control" id="ordercomm" placeholder='Comments about your Order'  aria-describedby="ordercomm1"
